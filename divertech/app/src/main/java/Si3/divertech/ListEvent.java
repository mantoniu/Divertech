...
public class ListEvent extends HashMap<Integer, Event> {
    ...
    public void mock(){
        ...
        put(1,new Event(1,"Event1",R.drawable.image_default,"Ceci est le premier évenement et c'est un long texte pour tester que ça marche bien","96 Avenue Millies Lacroix, Eaubonne, 95600", DESCRIPTION));
        put(2,new Event(2,"Event2",R.drawable.image_default,"Ceci est le deuxième évenement","83 cours Franklin Roosevelt, Marseille, 13009", DESCRIPTION));
        put(3,new Event(3,"Event3",R.drawable.image_default,"Ceci est le troisième évenement","30 rue du Château, Saint-Étienne, 42100", DESCRIPTION));
        put(4,new Event(4,"Event4",R.drawable.image_default,"Ceci est le quatrième évenement", "41 avenue de Provence, Valenciennes, 59300", DESCRIPTION));
        put(5,new Event(5,"Event5",R.drawable.image_default,"Ceci est le cinquième évenement"," 60 Rue Joseph Vernet, Bagneux, 92220", DESCRIPTION));
    }
