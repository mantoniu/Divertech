...
public class ListEvent {
    ...
    private static final Event event0 = new Event("0", "Concert", "https://github.com/mantoniu/Divertech/blob/main/image/event1-cropped.jpg?raw=true", "Ceci est le premier évenement et c'est un long texte pour tester que ça marche bien", "83 cours Franklin Roosevelt, Marseille, 13009", DESCRIPTION, LocalDateTime.of(2024, 8, 20, 0, 0).atZone(ZoneId.systemDefault()));
    private static final Event event1 = new Event("1", "Festival", "https://github.com/mantoniu/Divertech/blob/main/image/event2-cropped.jpg?raw=true", "Ceci est le deuxième évenement", "30 rue du Château, Saint-Étienne, 42100", DESCRIPTION, LocalDateTime.of(2024, 8, 13, 20, 0).atZone(ZoneId.systemDefault()));
    private static final Event event2 = new Event("2", "Film", "https://github.com/mantoniu/Divertech/blob/main/image/event3-cropped.jpg?raw=true", "Ceci est le troisième évenement", "41 avenue de Provence, Valenciennes, 59300", DESCRIPTION, LocalDateTime.of(2024, 9, 19, 21, 0).atZone(ZoneId.systemDefault()));
    private static final Event event3 = new Event("3", "Loto", "https://github.com/mantoniu/Divertech/blob/main/image/event4-cropped.jpg?raw=true", "Ceci est le quatrième évenement", "60 Rue Joseph Vernet, Bagneux, 92220", DESCRIPTION, LocalDateTime.of(2024, 7, 24, 14, 30).atZone(ZoneId.systemDefault()));
    private static final Event event4 = new Event("4", "Marché de Noel", "https://github.com/mantoniu/Divertech/blob/main/image/event5-cropped.jpg?raw=true", "Ceci est le cinquième évenement", "96 Avenue Millies Lacroix, Eaubonne, 95600", DESCRIPTION, LocalDateTime.of(2024, 12, 20, 14, 0).atZone(ZoneId.systemDefault()));
